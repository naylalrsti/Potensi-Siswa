            ...
            <div>
                <div className="w-80 md:w-fit flex flex-col justify-center items-center shadow rounded-md px-8 md:px-16 py-6">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <p className="text-base font-normal text-[14px] mt-3 text-center">
                        ...
                        <hr className="w-full border border-gray-200 mt-18" />
                        <h3 className="text-base font-normal text-[14px] mt-18 text-center">
                            ©2025 Potensi Siswa
                        </h3>
                    </div>
                </div>
