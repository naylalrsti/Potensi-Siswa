...
export default function faqPage() {
    return (
        <div className="w-full">
            <div className="w-full flex flex-col justify-center items-center mt-50 p-3">
                ...
                <div className="flex flex-col justify-center items-center mt-16">
                    <h2 className="text-base font-bold text-4xl text-center">
                        Halaman Tidak Ditemukan
                    </h2>
                    <p className="text-base font-normal text-normal mt-8 text-center">
